export class Shapes {
	...
	firstShapes() {
		...
		this.firstDraw(canvasContext);
		this.shapes(canvasContext);
	}

	private firstDraw(context: CanvasRenderingContext2D) {
		context.beginPath();
	...
	private shapes(context: CanvasRenderingContext2D) {
		context.beginPath();
